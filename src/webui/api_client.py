...
class APIClient:
    ...
    def search_text(self, query: str, top_k: int = 20, threshold: Optional[float] = None) -> Dict[str, Any]:
        """
        文本搜索
    ...
    def get_all_tasks(self, status: Optional[str] = None, task_type: Optional[str] = None) -> Dict[str, Any]:
        """
        获取所有任务
