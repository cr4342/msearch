...
class TaskScheduler:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.wait_time_compensation_interval = config.get("wait_time_compensation_interval", 60)  # 60秒
        ...
        self.priority_boost_threshold = config.get("priority_boost_threshold", 300)  # 5分钟
    ...
    async def _adjust_priorities(self):
        ...
        for prioritized_task in self._queue:
            ...
            if new_priority != task.priority:
                ...
                logger.debug(f"Task priority adjusted: {task.id}, new priority: {new_priority}")
