...
class PreprocessingCache:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.max_cache_size = preprocessing_config.get('max_cache_size', 5 * 1024 * 1024 * 1024)  # 5GB
    ...
    def cleanup_by_size(self) -> int:
        ...
        try:
            ...
            if total_size > self.max_cache_size:
                logger.info(f"缓存大小超过限制（当前: {total_size/1024/1024:.2f}MB, 限制: {self.max_cache_size/1024/1024:.2f}MB），开始清理")
