...
from PySide6.QtWidgets import (
    ...
    QCheckBox, QGroupBox, QTabWidget, QFileDialog,
...
class SettingsPanel(QWidget):
    ...
    def create_model_tab(self) -> QWidget:
        ...
        self.image_model_combo.addItems(["chinese_clip_large", "chinese_clip_base", "colqwen3_turbo", "tomoro_colqwen3"])
    ...
    def load_settings(self):
        ...
        self.health_check_interval_spin.setValue(system_config.get("health_check_interval", 30))
        ...
        self.max_concurrent_tasks_spin.setValue(task_manager_config.get("max_concurrent_tasks", 4))
        ...
        self.enable_model_warmup_checkbox.setChecked(models_config.get("enable_model_warmup", True))
